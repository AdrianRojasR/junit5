package org.arojas.appmockito.ejemplos.services;

import org.arojas.appmockito.ejemplos.Datos;
import org.arojas.appmockito.ejemplos.models.Examen;
import org.arojas.appmockito.ejemplos.repositories.ExamenRepository;
import org.arojas.appmockito.ejemplos.repositories.ExamenRepositoryImpl;
import org.arojas.appmockito.ejemplos.repositories.PreguntaRepository;
import org.arojas.appmockito.ejemplos.repositories.PreguntaRepositoryImpl;
...
//        service = new ExamenServiceImpl(repository, preguntaRepository);
    ...
    void findExamenPorNombre() {
        ...
        when(repository.findAll()).thenReturn(org.arojas.appmockito.ejemplos.Datos.EXAMENES);
    ...
    void testPreguntasExamen() {
        when(repository.findAll()).thenReturn(org.arojas.appmockito.ejemplos.Datos.EXAMENES);
        when(preguntaRepository.findPreguntasPorExamenId(anyLong())).thenReturn(org.arojas.appmockito.ejemplos.Datos.PREGUNTAS);
    ...
    void testGuardarExamen() {
        // Given
        Examen newExamen = org.arojas.appmockito.ejemplos.Datos.EXAMEN;
        newExamen.setPreguntas(org.arojas.appmockito.ejemplos.Datos.PREGUNTAS);
    ...
    void testManejoException() {
        when(repository.findAll()).thenReturn(org.arojas.appmockito.ejemplos.Datos.EXAMENES_ID_NULL);
...
//        verify(preguntaRepository).findPreguntasPorExamenId(eq(5L));
    ...
    void testArgumentMatchers2() {
        when(repository.findAll()).thenReturn(org.arojas.appmockito.ejemplos.Datos.EXAMENES_ID_NEGATIVOS);
        when(preguntaRepository.findPreguntasPorExamenId(anyLong())).thenReturn(org.arojas.appmockito.ejemplos.Datos.PREGUNTAS);
        service.findExamenPorNombreConPreguntas("Matemáticas");
...
//        when(preguntaRepository.findPreguntasPorExamenId(anyLong())).thenReturn(Datos.PREGUNTAS);
    ...
    @Test
    void testDoThrow() {
        Examen examen = org.arojas.appmockito.ejemplos.Datos.EXAMEN;
        examen.setPreguntas(org.arojas.appmockito.ejemplos.Datos.PREGUNTAS);
...
//        when(preguntaRepository.findPreguntasPorExamenId(anyLong())).thenReturn(Datos.PREGUNTAS);
        doAnswer(invocation -> {
            ...
            return id == 5L? org.arojas.appmockito.ejemplos.Datos.PREGUNTAS: Collections.emptyList();
